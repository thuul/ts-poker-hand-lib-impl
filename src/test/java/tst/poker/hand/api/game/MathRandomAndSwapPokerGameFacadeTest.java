 ...
 * @author walles
 */
public class MathRandomAndSwapPokerGameFacadeTest {

    public MathRandomAndSwapPokerGameFacadeTest() {
    }

    private final IPokerGameStarter instance = new MathRandomAndSwapPokerGameFacade();
        ...
        assertAll("PokerGameStartUp initialize test", () -> {
            ...
            assertAll("Card deck composition test", () -> {
                ...
                assertAll("Card shuffle test", () -> {
                    ...
                    /**
                     * calling a shuffle Algorithm based on
                     * {@link Math#random()} Algorithm for number randomization
                     * and {@link Collection} swapping.
                     */
